...
# -*- coding: utf-8 -*- #
"""*********************************************************************************************"""
#   FileName     [ upstream/speakervec/hubconf.py ]
#   Synopsis     [ the Speakervec torch hubconf ]
...
def speakervec_local(*args, **kwargs):
    return speakervec_custom(*args, **kwargs)


def speakervec_url(*args, **kwargs):
    return speakervec_custom(*args, **kwargs)


def speakervec(refresh=False, *args, **kwargs):
    """
    The default model - Base
        refresh (bool): whether to download ckpt/config again if existed
    """
    return speakervec_base(refresh=refresh, *args, **kwargs)


def speakervec_base(refresh=False, legacy=False, **kwargs):
    """
    The Base model
        refresh (bool): whether to download ckpt/config again if existed
    """
    ...
    return speakervec_custom(refresh=refresh, legacy=legacy, **kwargs)

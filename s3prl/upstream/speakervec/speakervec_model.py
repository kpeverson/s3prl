...
@dataclass
class SpeakervecPretrainingConfig:
...
class SpeakervecModel(torch.nn.Module):
    def __init__(
        self,
        cfg: SpeakervecConfig,
        task_cfg: SpeakervecPretrainingConfig,
        dictionaries: List[Any],
    ) -> None:
        super().__init__()
        logger.info(f"SpeakervecModel Config: {cfg}")
    ...
    @classmethod
    def build_model(cls, cfg: SpeakervecConfig, task):
        """Build a new model instance."""

        model = SpeakervecModel(cfg, task.cfg, task.dictionaries)
        return model

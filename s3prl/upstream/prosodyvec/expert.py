...
# -*- coding: utf-8 -*- #
"""*********************************************************************************************"""
#   FileName     [ upstream/prosodyvec/expert.py ]
#   Synopsis     [ the prosodyvec wrapper ]
...
class UpstreamExpert(UpstreamBase):
    ...
    def get_downsample_rates(self, key: str) -> int:
        print(f"self.task_cfg: {self.task_cfg}")
        downsample_rate = self.task_cfg.sample_rate // self.task_cfg.label_rate
        return downsample_rate # 320
...
#     def __init__(self, ckpt, **kwargs):
#         super().__init__(**kwargs)
#         logger.warning("Use the legacy expert for prosodyvec which depends on fairseq")
#         import fairseq

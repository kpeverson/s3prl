...
@dataclass
class ProsodyvecPretrainingConfig:
...
class ProsodyvecModel(torch.nn.Module):
    def __init__(
        self,
        ...
        super().__init__()
        logger.info(f"ProsodyvecModel Config: {cfg}")
    ...
    @classmethod
    def build_model(cls, cfg: ProsodyvecConfig, task):

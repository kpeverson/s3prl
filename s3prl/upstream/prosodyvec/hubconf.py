...
# -*- coding: utf-8 -*- #
"""*********************************************************************************************"""
#   FileName     [ upstream/prosodyvec/hubconf.py ]
#   Synopsis     [ the prosodyvec torch hubconf ]
...
def prosodyvec_custom(
    ...
    **kwargs,
    ...
    ckpt_wts = torch.load(ckpt)['model']
...
def prosodyvec_local(*args, **kwargs):
    return prosodyvec_custom(*args, **kwargs)


def prosodyvec_url(*args, **kwargs):
    return prosodyvec_custom(*args, **kwargs)


def prosodyvec(refresh=False, *args, **kwargs):
    """
    The default model - Base
        refresh (bool): whether to download ckpt/config again if existed
    """
    return prosodyvec_base(refresh=refresh, *args, **kwargs)


def prosodyvec_base(refresh=False, legacy=False, **kwargs):
    """
    The Base model
        refresh (bool): whether to download ckpt/config again if existed
    """
    ...
    return prosodyvec_custom(refresh=refresh, legacy=legacy, **kwargs)

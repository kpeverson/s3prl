...
ckpt_path=/gscratch/tial/kpever/workspace/prosodyvec/exps/old_gigaspeech_spectraltilt_targets/gigaspeech_glottal_lpf1000_normalized_rawprosody_spectraltilt_targets_spkr_stopgrad_wt1en1_lr_5em5_train_tmp/checkpoints/checkpoint_best.pt
...
output_name=prosodyvec_gigaspeech_lpf1000_rawprosody_spectraltilt_targets_spkr_stopgrad_bu_radio_tones

...
# upstream=mel
downstream_config_path=/gscratch/tial/kpever/workspace/s3prl/s3prl/downstream/bu_radio_breaks/config_rawprosody_beforeafter_012v3v4_CEloss.yaml
downstream=bu_radio_breaks
output_name=rawprosody_spectraltilt_feats_bu_radio_breaks_beforeafter_012v3v4_CE

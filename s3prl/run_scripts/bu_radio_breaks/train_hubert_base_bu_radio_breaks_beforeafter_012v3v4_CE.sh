...
downstream_config_path=/gscratch/tial/kpever/workspace/s3prl/s3prl/downstream/bu_radio_breaks/config_hubert_beforeafter_012v3v4_CEloss.yaml
downstream=bu_radio_breaks
output_name=hubert_base_bu_radio_breaks_beforeafter_012v3v4_CE

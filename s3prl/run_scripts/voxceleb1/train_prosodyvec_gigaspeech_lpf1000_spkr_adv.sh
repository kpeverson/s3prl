...
ckpt_path=/gscratch/tial/kpever/workspace/prosodyvec/exps/gigaspeech_glottal_lpf1000_normalized_rawprosody_targets_spkr_adv_wt1en1_lr_5em5_train_tmp/checkpoints/checkpoint_best.pt
...
output_name=prosodyvec_gigaspeech_lpf1000_spkr_adv_voxceleb1
